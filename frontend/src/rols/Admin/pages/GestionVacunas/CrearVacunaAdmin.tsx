...
const CrearVacunaAdmin: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 style={{ color: "#145214", marginBottom: 18 }}>
        Crear vacuna para animal
      </h2>
      <form
      ...
      >
        ...
        <select
          ...
          required
          style={{ padding: 8, borderRadius: 8, border: "1.5px solid #43ea6b" }}
        >
        ...
        {success && (
          <div style={{ color: "#228B22", marginTop: 8 }}>{success}</div>
        )}
