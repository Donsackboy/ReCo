        ...
        <div className="general-form">
              ...
              >
                ...
                {ESTADO_SALUD_OPCIONES.map((opt) => (
                  <option
                    key={opt.value}
                    value={opt.value}
                    style={{ color: "#1a4fa3", fontWeight: "bold" }}
                  >
                    {opt.label}
                  </option>
                ))}
          ...
          <div className="form-row">
            ...
            <input
              ...
              value={localFicha.fecha_ultimo_control}
              onChange={handleChange}
            />
          </div>
          <div className="form-row">
            ...
            <input
              ...
              value={localFicha.veterinario_responsable}
              onChange={handleChange}
            />
          </div>
          <div className="form-row">
          ...
          <div className="form-row">
            ...
            <textarea
              ...
              value={localFicha.recomendaciones}
              onChange={handleChange}
            />
          </div>
        </div>
