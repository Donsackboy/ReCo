...
export async function createNecesidadRefugio(data: any, token: string): Promise<any> {
	const response = await fetch(`${API_BASE}/necesidades-refugio/`, {
		method: 'POST',
		headers: {
...
export async function updateNecesidadRefugio(id: number, data: any, token: string): Promise<any> {
...
export async function deleteNecesidadRefugio(id: number, token: string): Promise<boolean> {
	const response = await fetch(`${API_BASE}/necesidades-refugio/${id}/`, {
		method: 'DELETE',
		headers: {
			'Authorization': `Token ${token}`,
...
export async function createAnimal(data: AnimalData, token: string): Promise<any> {
	const response = await fetch(`${API_BASE}/animales/`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
...
export async function updateAnimal(id: number, data: AnimalData, token: string): Promise<any> {
...
// 🩺 Cirugías
// ---------------------------------------------------------------------------
export async function getCirugias(token: string, animalId?: number): Promise<any> {
...
export async function deleteCirugia(id: number, token: string): Promise<boolean> {
	const response = await fetch(`${API_BASE}/cirugias/${id}/`, {
		method: 'DELETE',
		headers: { 'Authorization': `Token ${token}` },
	});
...
// 💊 Tratamientos
// ---------------------------------------------------------------------------
export async function getTratamientos(token: string, animalId?: number): Promise<any> {
...
export async function createTratamiento(data: TratamientoData, token: string): Promise<any> {
...
export async function updateTratamiento(id: number, data: TratamientoData, token: string): Promise<any> {
...
export async function deleteTratamiento(id: number, token: string): Promise<boolean> {
	const response = await fetch(`${API_BASE}/tratamientos/${id}/`, {
		method: 'DELETE',
		headers: { 'Authorization': `Token ${token}` },
	});
...
// ---------------------------------------------------------------------------
export async function getAdopcionesPendientesRefugio(token: string): Promise<number> {
...
// ---------------------------------------------------------------------------
export async function getFichaMedica(token: string, animalId: number): Promise<any> {
...
export async function updateFichaMedica(token: string, animalId: number, data: any): Promise<any> {
	const response = await fetch(`${API_BASE}/fichamedica/${animalId}/`, {
		method: 'PATCH',
		headers: {
			'Content-Type': 'application/json',
...
// ---------------------------------------------------------------------------
export async function getVacunas(token: string, animalId: number): Promise<any> {
...
export async function createVacuna(token: string, animalId: number, data: VacunaData): Promise<any> {
	const response = await fetch(`${API_BASE}/animales/${animalId}/vacunas/`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
...
export async function updateVacuna(token: string, animalId: number, vacunaId: number, data: VacunaData): Promise<any> {
	const response = await fetch(`${API_BASE}/animales/${animalId}/vacunas/${vacunaId}/`, {
		method: 'PATCH',
		headers: {
			'Content-Type': 'application/json',
