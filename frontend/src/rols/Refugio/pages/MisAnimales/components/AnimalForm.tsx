  ...
  if (!refugioId) {
    return (
      <div style={{ color: "red", padding: 20 }}>
        Error: Tu usuario no tiene un refugio asociado. No puedes crear
        animales.
      </div>
    );
  }
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <option value="buscando_nuevo_hogar_temporal">
                Buscando nuevo hogar temporal
              </option>
            </select>
          </div>
        </div>
                    ...
                    style={{
                      background:
                        currentFoto === form.fotos.length - 1
                          ...
                          : "#43ea6b",
                      color:
                        currentFoto === form.fotos.length - 1 ? "#aaa" : "#fff",
                      border: "none",
                      borderRadius: "8px",
                      padding: "6px 18px",
                      fontWeight: 700,
