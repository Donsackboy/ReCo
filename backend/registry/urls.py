...
urlpatterns = [
    ...
    path('public/eventos/', views.EventoPublicListView.as_view(), name='public_eventos_list'),
    path('public/eventos/<int:evento_id>/inscribirse/', views.EventoInscripcionView.as_view(), name='public_eventos_inscribirse'),
    path('refugio/eventos/<int:evento_id>/inscripciones/', views.EventoInscripcionesRefugioView.as_view(), name='refugio_evento_inscripciones'),
