...
const eventos = [
  {
    ...
    fecha: "10 Nov",
    descripcion:
      "Ven a conocer a nuestros peluditos y encuentra a tu nuevo mejor amigo.",
    imagen: "/Images/eventos/jornada.jpg",
  },
  {
    id: 2,
    titulo: "Charla: Tenencia Responsable",
    fecha: "15 Nov",
    descripcion: "Aprende sobre el compromiso de adoptar y cuidar.",
    imagen: "/Images/eventos/charla.jpg",
  },
  {
    id: 3,
    titulo: "Fiesta Canina",
    fecha: "20 Nov",
    descripcion: "Un día de juegos y diversión para toda la familia.",
    imagen: "/Images/eventos/fiesta.jpg",
  },
];
    ...
    <div className="home">
          ...
          >
            {animalesCarousel.slice(0, 4).map((animal) => {
              const animalCardData = {
                ...
                imagenes: animal.foto_principal
      ...
      <section className="refugio-apply-section">
        <div className="refugio-apply-card">
          ...
          <p>
            Si tienes un refugio y quieres sumarte a ReCo, puedes rellenar un
            formulario para que tus animales sean parte de nuestra red y reciban
            más visibilidad y apoyo.
          </p>
          <ul>
            <li>
              ✔️ Refugios legalmente constituidos, en proceso de formalización,
              o grupos con entre 15 y 20 animales bajo cuidado.
            </li>
            <li>
              ✔️ Compromiso con el bienestar animal y la adopción responsable.
            </li>
            <li>
              ✔️ Disposición para colaborar y compartir información de los
              animales.
            </li>
          </ul>
          <p style={{ marginTop: 8 }}>
            El formulario será evaluado por el equipo de ReCo. Posteriormente,
            la persona responsable será contactada para confirmar ciertos
            detalles y continuar el proceso.
          </p>
          <Link
            to="/postulacion-refugio"
        ...
        <div className="info-cards">
          <div className="info-card">
            ...
            <div>
              ...
              <p>
                Personas mayores de edad, con compromiso y amor por los
                animales.
              </p>
            </div>
          </div>
          <div className="info-card">
            ...
            <div>
              ...
              <p>
                Espacio seguro y tiempo para dedicar a la adaptación del animal.
              </p>
            </div>
          </div>
          <div className="info-card">
            ...
            <div>
              ...
              <p>
                La adopción no es para devolver al animal, sino para integrarlo
                a tu familia.
              </p>
            </div>
          </div>
      ...
      <section className="advice-section">
        ...
        <ul className="advice-list">
          <li>
            🐶 Los animalitos pueden demorar en adaptarse a un nuevo hogar.
          </li>
          ...
          {eventos.map((ev) => (
            <div className="event-card" key={ev.id}>
              ...
              <div className="event-info">
                ...
                <h3>{ev.titulo}</h3>
                <p>{ev.descripcion}</p>
                <Link to="/eventos" className="event-link">
                  Ver más eventos
                </Link>
              </div>
            </div>
      ...
      <section className="donation-section">
        ...
        <div className="donation-info">
          ...
          <p>
            Tu donación permite que más animales reciban atención, alimento y
            cariño mientras esperan una familia. ¡Cada aporte cuenta!
          </p>
          <Link to="/donaciones" className="btn-donation">
            Ir a Donaciones
          </Link>
        </div>
      </section>
