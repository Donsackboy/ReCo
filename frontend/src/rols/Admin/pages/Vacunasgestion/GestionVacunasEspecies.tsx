...
import {
  getEspecies,
  createEspecie,
  getListasVacunasEspecie,
  createListaVacunasEspecie,
} from "../../Api/ApiAdmin";
...
const GestionVacunasEspecies: React.FC = () => {
  ...
  const handleAddEspecie = async (e: React.FormEvent) => {
    ...
    if (!token) return;
    try {
      const especieCreada = await createEspecie(token, {
  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <button
        onClick={() => setShowFormEspecie(true)}
        style={{
          marginBottom: "1rem",
          background: "#2a5d8a",
          color: "white",
      ...
      {showFormEspecie && (
        ...
        >
          <div
            style={{
              background: "linear-gradient(135deg, #f4f8fb 80%, #e3eaf3 100%)",
              padding: "2.5rem 2rem",
              borderRadius: "18px",
              boxShadow: "0 8px 32px #2a5d8a44",
              minWidth: 370,
              maxWidth: 440,
              position: "relative",
          ...
          >
            <button
              aria-label="Cerrar"
              onClick={() => setShowFormEspecie(false)}
              style={{
                position: "absolute",
                top: 18,
                right: 18,
            ...
            >
              ...
              <button
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #2a5d8a 60%, #4a8ad4 100%)",
                  color: "white",
                  border: "none",
                  borderRadius: "8px",
                  padding: "0.8rem 1.3rem",
      ...
      {showFormVacuna && (
        ...
        >
          ...
          >
            <button
              aria-label="Cerrar"
              onClick={() => setShowFormVacuna(false)}
              style={{
                position: "absolute",
                top: 18,
                right: 18,
            ...
            >
              ...
              >
                ...
                >
                  <label style={{ fontWeight: 600, color: "#2a5d8a" }}>
                    Nombre
                  </label>
                  <input
                    type="text"
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, obligatoria: e.target.checked })
                  }
      ...
      >
        {especies.length === 0 ? (
          ...
          especies.map((especie) => {
            const listasEspecie = listas.filter(
              (lista) => lista.especie === especie.id
            );
            return (
              <div
                key={especie.id}
              ...
              >
                ...
                >
                  <h2 style={{ color: "#2a5d8a", margin: 0 }}>
                    {especie.nombre}
                  </h2>
                  <button
                    style={{
                  ...
                  >
                    {listasEspecie.map((lista) => (
                      ...
                      >
                        ...
                        <p>
                          <b>Descripción:</b> {lista.descripcion}
                        </p>
                        <p>
                          <b>Frecuencia:</b> {lista.frecuencia}
                        </p>
                        <p>
                          <b>Dosis:</b> {lista.dosis}
                        </p>
                        <p>
                          <b>Obligatoria:</b> {lista.obligatoria ? "Sí" : "No"}
                        </p>
                        <p>
                          <b>Tipo:</b> {lista.tipo}
                        </p>
                        <p>
                          <b>Precio:</b> ${lista.precio}
                        </p>
                        <button
                          style={{ marginTop: "0.5rem" }}
                          onClick={() => setDetalleId(lista.id)}
                        >
                          Ver lista de vacunas
                        </button>
                        {detalleId === lista.id && (
                          <div
                            style={{
