...
function UsuarioPerfil() {
  ...
  const API_URL = `${import.meta.env.VITE_API_BASE}/auth/profile/`;
  ...
  return (
    <div className="usuario-perfil-container">
      ...
      {editando && (
        <div className="usuario-editar-form">
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 12 }}>
            <button className="form-boton-btn" onClick={handleGuardar}>
              Guardar cambios
            </button>
            <button
              className="form-boton-btn cancelar-btn"
      ...
      {editandoPassword && (
        ...
        >
          <h3 style={{ marginBottom: 16, color: "#229954" }}>
            Cambiar contraseña
          </h3>
          <div className="form-row">
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 12 }}>
            <button className="form-boton-btn" onClick={handleGuardarPassword}>
